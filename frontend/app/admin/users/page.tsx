...
export default function UsersPage() {
  ...
  return (
    <section>
      <PageHeader title="Users" subtitle="จัดการผู้ใช้งานในระบบ" />
        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            <form onSubmit={submit} className="grid sm:grid-cols-3 gap-4">
              ...
              <div className="sm:col-span-3"><Button>+ เพิ่มผู้ใช้</Button></div>
            </form>
          </CardContent>
        </Card>
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="bg-muted border-b border-border">
                <th className="text-left px-3 py-2.5 text-[10.5px] font-semibold uppercase tracking-wider text-muted-foreground">ID</th>
                <th className="text-left px-3 py-2.5 text-[10.5px] font-semibold uppercase tracking-wider text-muted-foreground">Email</th>
                <th className="text-left px-3 py-2.5 text-[10.5px] font-semibold uppercase tracking-wider text-muted-foreground">ชื่อ</th>
                <th className="text-left px-3 py-2.5 text-[10.5px] font-semibold uppercase tracking-wider text-muted-foreground">สถานะ</th>
              </tr>
            </thead>
            <tbody>
              {users.map((u) => (
